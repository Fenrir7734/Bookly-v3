...
import com.fenrir.auth.exception.exceptions.ResourceCreationException;
...
public class RestResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleForbiddenException(RuntimeException ex, WebRequest request) {
        ErrorMessage message = new ErrorMessage(
